...
namespace CalculatorWebsite
{
    public class Startup
    {
        ...
        public void ConfigureDatabaseContext(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("SqlCalculatorDB"));
            });

            services.AddScoped<DbContext, CalculatorContext>();
            services.AddScoped<ICalculatorRepository, CalculatorRepository>();
            services.AddScoped<IDebugReport, DebugReporter>();
